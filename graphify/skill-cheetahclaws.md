...
> **CheetahClaws platform:** Multi-agent support is still early on CheetahClaws. Extraction runs sequentially — you read and extract each file yourself. This is slower than parallel platforms but fully reliable.

Print: `"Semantic extraction: N files (sequential — CheetahClaws)"`
...
**Step B2 - Sequential extraction (CheetahClaws)**
